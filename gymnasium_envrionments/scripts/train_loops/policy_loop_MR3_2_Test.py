...
#####################################################################################################33
            ...
            for eval_episode_counter in range(number_eval_episodes):
                ...
                len1 = sub_state1.shape[0]
                len2 = sub_state2.shape[0]
                min_len = min(len1, len2)
                sub_state1_aligned = sub_state1[-min_len:, :]
                # print(sub_state1_aligned)
                sub_state2_aligned = sub_state2[-min_len:, :]
                distance = np.sum(np.linalg.norm(sub_state1_aligned - sub_state2_aligned, axis=1))
        ...
        output_file = os.path.join("./Metamorphic/Test_outcome", f"MR3.2_output_{Model_name + 1}.csv")
