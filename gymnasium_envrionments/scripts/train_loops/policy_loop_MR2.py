...
#####################################################################################################33
            ...
            for eval_episode_counter in range(number_eval_episodes):
                ...
                distance = sum(total_reward1[:70]) - sum(total_reward2[:10])
                ...
                if flag == 0:
                    ...
                    if eval_episode_counter % 20 ==0:
                        output_file = os.path.join("./Metamorphic/training_threshold", "MR2_threshold_FalsePositive_test_case.csv")
        ...
        if flag == 0:
            output_file = os.path.join("./Metamorphic/training_threshold", "MR2_threshold_FalsePositive_test_suite.csv")
            with open(output_file, mode='a', newline='') as F:
                writer = csv.writer(F)
                writer.writerow([para])
