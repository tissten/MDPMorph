...
def evaluate_policy_network(
    ...
    ###########################################################
    file_names = [rf"./Metamorphic/test suite\T{i}.txt" for i in range(40, 50)]
    # para = 0
    # k = 0
...
#####################################################################################################33
        ...
        output_file = os.path.join("./Metamorphic/Test_outcome", f"MR1.1_output_{Model_name + 1}.csv")
        ...
        with open(output_file, "a", newline="") as f:
            ...
            writer.writerow([MR1_1 / tot_num, tot_num])
