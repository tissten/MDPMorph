...
#####################################################################################################33
            ...
            for eval_episode_counter in range(number_eval_episodes):
                ...
                if total_state1.shape[0] != total_state2.shape[0]:
                    len1 = total_state1.shape[0]
                    len2 = total_state2.shape[0]
                    min_len = min(len1, len2)
                    total_state1 = total_state1[:min_len, :]
                    # print(sub_state1_aligned)
                    total_state2 = total_state2[:min_len, :]
        ...
        output_file = os.path.join("./Metamorphic/Test_outcome", f"MR4_output_{Model_name + 1}.csv")
